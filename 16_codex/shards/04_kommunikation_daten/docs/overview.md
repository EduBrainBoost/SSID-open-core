# Kommunikation und Daten — Codex Overview

## Scope

Provides Knowledge indexing, schema validation, and documentation registry within the Kommunikation und Daten domain.
...
- Domain-specific Codex functions for Kommunikation und Daten
