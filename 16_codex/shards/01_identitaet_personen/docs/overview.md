# Identitaet und Personen — Codex Overview

## Scope

Provides Knowledge indexing, schema validation, and documentation registry within the Identitaet und Personen domain.
...
- Domain-specific Codex functions for Identitaet und Personen
