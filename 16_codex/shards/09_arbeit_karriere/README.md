# Codex / Arbeit und Karriere

## Purpose

This shard provides Knowledge indexing, schema validation, and documentation registry for the domain **Arbeit und Karriere**.
...
- Produces: Domain-specific Codex outputs for Arbeit und Karriere
