# Behoerden und Verwaltung — Codex Overview

## Scope

Provides Knowledge indexing, schema validation, and documentation registry within the Behoerden und Verwaltung domain.
...
- Domain-specific Codex functions for Behoerden und Verwaltung
