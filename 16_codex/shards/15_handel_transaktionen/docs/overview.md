# Handel und Transaktionen — Codex Overview

## Scope

Provides Knowledge indexing, schema validation, and documentation registry within the Handel und Transaktionen domain.
...
- Domain-specific Codex functions for Handel und Transaktionen
