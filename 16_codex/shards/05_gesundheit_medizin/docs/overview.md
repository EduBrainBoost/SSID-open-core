# Gesundheit und Medizin — Codex Overview

## Scope

Provides Knowledge indexing, schema validation, and documentation registry within the Gesundheit und Medizin domain.
...
- Domain-specific Codex functions for Gesundheit und Medizin
