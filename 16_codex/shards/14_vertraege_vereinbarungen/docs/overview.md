# Vertraege und Vereinbarungen — Codex Overview

## Scope

Provides Knowledge indexing, schema validation, and documentation registry within the Vertraege und Vereinbarungen domain.
...
- Domain-specific Codex functions for Vertraege und Vereinbarungen
