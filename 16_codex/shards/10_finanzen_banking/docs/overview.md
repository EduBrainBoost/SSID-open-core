# Finanzen und Banking — Codex Overview

## Scope

Provides Knowledge indexing, schema validation, and documentation registry within the Finanzen und Banking domain.
...
- Domain-specific Codex functions for Finanzen und Banking
