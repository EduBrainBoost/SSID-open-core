...
**Root**: `23_compliance` | **Shard**: `05_gesundheit_medizin`

## Scope

Handles health and medical data within the Compliance layer.
All operations are non-custodial and hash-only compliant.

## Key Components

- `gesundheit_medizin_module.py`: Core ComplianceChecker implementation
