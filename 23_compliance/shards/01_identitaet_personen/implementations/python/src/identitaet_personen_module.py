"""Compliance checker for identity and person management in 23_compliance/01_identitaet_personen."""
import hashlib
import json
...
class ComplianceChecker:
    """Compliance checker: regulation, requirement, evidence for Identitaet & Personen."""
