"""Compliance checker for real estate and property in 23_compliance/12_immobilien_grundstuecke."""
...
class ComplianceChecker:
    """Compliance checker: regulation, requirement, evidence for Immobilien & Grundstuecke."""
