...
**Root**: `23_compliance` | **Shard**: `09_arbeit_karriere`

## Scope

Handles employment and career tracking within the Compliance layer.
All operations are non-custodial and hash-only compliant.

## Key Components

- `arbeit_karriere_module.py`: Core ComplianceChecker implementation
