...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="SSID Production Readiness Checker")
    ...
    if args.json:
        ...
        lines = [f"Production Readiness Report — {report.timestamp}", f"Verdict: {report.verdict}", ""]
