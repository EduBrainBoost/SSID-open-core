...
| Git Bash vs PowerShell path differences | Git Bash uses `/c/Users/...`, PowerShell uses `C:\Users\...` | Pick one shell and stay consistent. Git Bash is recommended for this project. If using PowerShell, translate paths: `C:\Users\<user>\Documents\Github\SSID`. |
