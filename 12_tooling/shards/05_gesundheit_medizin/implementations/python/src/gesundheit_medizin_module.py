"""Tool execution and configuration management - Gesundheit & Medizin domain module."""
...
class ToolRunner:
    """Tool execution and configuration management for the health and medicine domain."""

    def __init__(self, shard: str = "05_gesundheit_medizin"):
        self.shard = shard
