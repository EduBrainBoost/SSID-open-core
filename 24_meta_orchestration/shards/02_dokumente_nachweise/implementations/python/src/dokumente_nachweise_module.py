"""Orchestration coordinator for document and credential verification in 24_meta_orchestration/02_dokumente_nachweise."""
...
class OrchestrationCoordinator:
    """Orchestration coordinator: dispatch, monitor, evidence for Dokumente & Nachweise."""

    def __init__(self, shard_id: str = "02_dokumente_nachweise"):
