"""Basic tests for Core / Finanzen & Banking shard."""
import os
import unittest
...
class TestValidator10FinanzenBankingBasic(unittest.TestCase):
    """Validate chart.yaml integrity for 10_finanzen_banking."""
    ...
    def test_shard_name_correct(self):
        self.assertEqual(self.chart.get("shard"), "10_finanzen_banking")
