"""Basic tests for Core / Identitaet & Personen shard."""
import os
import unittest
...
class TestValidator01IdentitaetPersonenBasic(unittest.TestCase):
    """Validate chart.yaml integrity for 01_identitaet_personen."""
    ...
    def test_shard_name_correct(self):
        self.assertEqual(self.chart.get("shard"), "01_identitaet_personen")
