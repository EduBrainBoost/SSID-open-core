"""Basic tests for Core / Mobilitaet & Fahrzeuge shard."""
import os
import unittest
...
class TestValidator08MobilitaetFahrzeugeBasic(unittest.TestCase):
    """Validate chart.yaml integrity for 08_mobilitaet_fahrzeuge."""
    ...
    def test_shard_name_correct(self):
        self.assertEqual(self.chart.get("shard"), "08_mobilitaet_fahrzeuge")
