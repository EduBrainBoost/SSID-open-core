"""Basic tests for Core / Bildung & Qualifikationen shard."""
import os
import unittest
...
class TestValidator06BildungQualifikationenBasic(unittest.TestCase):
    """Validate chart.yaml integrity for 06_bildung_qualifikationen."""
    ...
    def test_shard_name_correct(self):
        self.assertEqual(self.chart.get("shard"), "06_bildung_qualifikationen")
