"""Basic tests for Core / Vertraege & Vereinbarungen shard."""
import os
import unittest
...
class TestValidator14VertraegeVereinbarungenBasic(unittest.TestCase):
    """Validate chart.yaml integrity for 14_vertraege_vereinbarungen."""
    ...
    def test_shard_name_correct(self):
        self.assertEqual(self.chart.get("shard"), "14_vertraege_vereinbarungen")
