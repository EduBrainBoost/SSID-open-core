"""Basic tests for Core / Zugang & Berechtigungen shard."""
...
class TestValidator03ZugangBerechtigungenBasic(unittest.TestCase):
    """Validate chart.yaml integrity for 03_zugang_berechtigungen."""
    ...
    def test_shard_name_correct(self):
        self.assertEqual(self.chart.get("shard"), "03_zugang_berechtigungen")
