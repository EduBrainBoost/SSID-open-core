"""Basic tests for Core / Behoerden & Verwaltung shard."""
import os
import unittest
...
class TestValidator16BehoerdenVerwaltungBasic(unittest.TestCase):
    """Validate chart.yaml integrity for 16_behoerden_verwaltung."""
    ...
    def test_shard_name_correct(self):
        self.assertEqual(self.chart.get("shard"), "16_behoerden_verwaltung")
