"""Basic tests for Core / Dokumente & Nachweise shard."""
...
class TestValidator02DokumenteNachweiseBasic(unittest.TestCase):
    """Validate chart.yaml integrity for 02_dokumente_nachweise."""
    ...
    def test_shard_name_correct(self):
        self.assertEqual(self.chart.get("shard"), "02_dokumente_nachweise")
