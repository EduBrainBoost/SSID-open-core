"""Basic tests for Core / Gesundheit & Medizin shard."""
import os
import unittest
...
class TestValidator05GesundheitMedizinBasic(unittest.TestCase):
    """Validate chart.yaml integrity for 05_gesundheit_medizin."""
    ...
    def test_shard_name_correct(self):
        self.assertEqual(self.chart.get("shard"), "05_gesundheit_medizin")
