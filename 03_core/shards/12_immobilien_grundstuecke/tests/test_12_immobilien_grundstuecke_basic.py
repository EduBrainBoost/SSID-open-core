"""Basic tests for Core / Immobilien & Grundstuecke shard."""
import os
import unittest
...
class TestValidator12ImmobilienGrundstueckeBasic(unittest.TestCase):
    """Validate chart.yaml integrity for 12_immobilien_grundstuecke."""
    ...
    def test_shard_name_correct(self):
        self.assertEqual(self.chart.get("shard"), "12_immobilien_grundstuecke")
