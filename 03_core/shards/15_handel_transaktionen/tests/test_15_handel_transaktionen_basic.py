"""Basic tests for Core / Handel & Transaktionen shard."""
import os
import unittest
...
class TestValidator15HandelTransaktionenBasic(unittest.TestCase):
    """Validate chart.yaml integrity for 15_handel_transaktionen."""
    ...
    def test_shard_name_correct(self):
        self.assertEqual(self.chart.get("shard"), "15_handel_transaktionen")
