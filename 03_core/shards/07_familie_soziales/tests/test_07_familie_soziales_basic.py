"""Basic tests for Core / Familie & Soziales shard."""
import os
import unittest
...
class TestValidator07FamilieSozialesBasic(unittest.TestCase):
    """Validate chart.yaml integrity for 07_familie_soziales."""
    ...
    def test_shard_name_correct(self):
        self.assertEqual(self.chart.get("shard"), "07_familie_soziales")
