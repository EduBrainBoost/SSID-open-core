"""Basic tests for Core / Arbeit & Karriere shard."""
import os
import unittest
...
class TestValidator09ArbeitKarriereBasic(unittest.TestCase):
    """Validate chart.yaml integrity for 09_arbeit_karriere."""
    ...
    def test_shard_name_correct(self):
        self.assertEqual(self.chart.get("shard"), "09_arbeit_karriere")
