...
**Root**: `23_compliance` | **Shard**: `11_versicherungen_risiken`

## Scope

Handles insurance and risk management within the Compliance layer.
All operations are non-custodial and hash-only compliant.

## Key Components

- `versicherungen_risiken_module.py`: Core ComplianceChecker implementation
