...
**Root**: `23_compliance` | **Shard**: `15_handel_transaktionen`

## Scope

Handles trade and transaction processing within the Compliance layer.
All operations are non-custodial and hash-only compliant.

## Key Components

- `handel_transaktionen_module.py`: Core ComplianceChecker implementation
