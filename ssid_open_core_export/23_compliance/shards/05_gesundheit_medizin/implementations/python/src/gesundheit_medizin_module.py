"""Compliance checker for health and medical data in 23_compliance/05_gesundheit_medizin."""
...
class ComplianceChecker:
    """Compliance checker: regulation, requirement, evidence for Gesundheit & Medizin."""
