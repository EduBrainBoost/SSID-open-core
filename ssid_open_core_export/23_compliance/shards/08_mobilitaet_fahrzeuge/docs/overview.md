...
**Root**: `23_compliance` | **Shard**: `08_mobilitaet_fahrzeuge`

## Scope

Handles mobility and vehicle management within the Compliance layer.
All operations are non-custodial and hash-only compliant.

## Key Components

- `mobilitaet_fahrzeuge_module.py`: Core ComplianceChecker implementation
