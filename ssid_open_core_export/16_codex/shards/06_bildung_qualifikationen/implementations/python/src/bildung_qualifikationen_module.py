"""Codex module for Bildung und Qualifikationen — Knowledge Indexer."""
...
class KnowledgeIndexer:
    """Knowledge indexer for Bildung und Qualifikationen in the Codex."""
    ...
    def index_entry(self, entry_id: str, content: dict) -> dict:
        ...
        record = {
            ...
            "domain": "bildung_qualifikationen",
            "non_custodial": True,
        }
