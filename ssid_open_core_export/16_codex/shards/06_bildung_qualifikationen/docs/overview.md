# Bildung und Qualifikationen — Codex Overview

## Scope

Provides Knowledge indexing, schema validation, and documentation registry within the Bildung und Qualifikationen domain.
...
- Domain-specific Codex functions for Bildung und Qualifikationen
