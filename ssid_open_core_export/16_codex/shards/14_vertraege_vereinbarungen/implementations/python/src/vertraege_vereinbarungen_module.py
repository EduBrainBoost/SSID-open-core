"""Codex module for Vertraege und Vereinbarungen — Knowledge Indexer."""
...
class KnowledgeIndexer:
    """Knowledge indexer for Vertraege und Vereinbarungen in the Codex."""
    ...
    def index_entry(self, entry_id: str, content: dict) -> dict:
        ...
        record = {
            ...
            "domain": "vertraege_vereinbarungen",
            "non_custodial": True,
        }
