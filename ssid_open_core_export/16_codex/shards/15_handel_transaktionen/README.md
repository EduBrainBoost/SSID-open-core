# Codex / Handel und Transaktionen

## Purpose

This shard provides Knowledge indexing, schema validation, and documentation registry for the domain **Handel und Transaktionen**.
...
- Produces: Domain-specific Codex outputs for Handel und Transaktionen
