# Dokumente und Nachweise — Codex Overview

## Scope

Provides Knowledge indexing, schema validation, and documentation registry within the Dokumente und Nachweise domain.
...
- Domain-specific Codex functions for Dokumente und Nachweise
