# Arbeit und Karriere — Codex Overview

## Scope

Provides Knowledge indexing, schema validation, and documentation registry within the Arbeit und Karriere domain.
...
- Domain-specific Codex functions for Arbeit und Karriere
