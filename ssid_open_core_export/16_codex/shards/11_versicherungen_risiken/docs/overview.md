# Versicherungen und Risiken — Codex Overview

## Scope

Provides Knowledge indexing, schema validation, and documentation registry within the Versicherungen und Risiken domain.
...
- Domain-specific Codex functions for Versicherungen und Risiken
