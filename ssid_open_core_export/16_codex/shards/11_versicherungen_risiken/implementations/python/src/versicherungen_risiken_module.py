"""Codex module for Versicherungen und Risiken — Knowledge Indexer."""
...
class KnowledgeIndexer:
    """Knowledge indexer for Versicherungen und Risiken in the Codex."""
