# Codex / Familie und Soziales

## Purpose

This shard provides Knowledge indexing, schema validation, and documentation registry for the domain **Familie und Soziales**.
...
- Produces: Domain-specific Codex outputs for Familie und Soziales
