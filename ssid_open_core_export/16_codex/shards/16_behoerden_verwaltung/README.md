# Codex / Behoerden und Verwaltung

## Purpose

This shard provides Knowledge indexing, schema validation, and documentation registry for the domain **Behoerden und Verwaltung**.
...
- Produces: Domain-specific Codex outputs for Behoerden und Verwaltung
