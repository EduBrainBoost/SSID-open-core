# Codex / Unternehmen und Gewerbe

## Purpose

This shard provides Knowledge indexing, schema validation, and documentation registry for the domain **Unternehmen und Gewerbe**.
...
- Produces: Domain-specific Codex outputs for Unternehmen und Gewerbe
