# Codex / Mobilitaet und Fahrzeuge

## Purpose

This shard provides Knowledge indexing, schema validation, and documentation registry for the domain **Mobilitaet und Fahrzeuge**.
...
- Produces: Domain-specific Codex outputs for Mobilitaet und Fahrzeuge
