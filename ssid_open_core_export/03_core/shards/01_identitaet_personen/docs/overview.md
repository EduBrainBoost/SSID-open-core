# Identitaet & Personen -- Technische Uebersicht (Core)

## Funktion

Kernvalidierung von Identitaetsdaten und Personenprofilen.
Verarbeitet ausschliesslich gehashte Daten (SHA3-256) gemaess Non-Custodial-Prinzip.

## Abhaengigkeiten

- `03_core/shards/01_identitaet_personen/chart.yaml` -- Shard-Konfiguration
