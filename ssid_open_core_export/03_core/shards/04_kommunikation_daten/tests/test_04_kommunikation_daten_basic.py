...
class TestValidator04KommunikationDatenBasic(unittest.TestCase):
    """Validate chart.yaml integrity for 04_kommunikation_daten."""
    ...
    def test_shard_name_correct(self):
        self.assertEqual(self.chart.get("shard"), "04_kommunikation_daten")
