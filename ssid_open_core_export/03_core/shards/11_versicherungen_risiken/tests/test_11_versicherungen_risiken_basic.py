"""Basic tests for Core / Versicherungen & Risiken shard."""
...
class TestValidator11VersicherungenRisikenBasic(unittest.TestCase):
    """Validate chart.yaml integrity for 11_versicherungen_risiken."""
    ...
    def test_shard_name_correct(self):
        self.assertEqual(self.chart.get("shard"), "11_versicherungen_risiken")
