...
class GDPREnforcer:
    ...
    def validate_consent(self, consent_record: dict[str, Any] | None) -> GDPREnforcementResult:
        ...
        if expires_at is not None and isinstance(expires_at, (int, float)) and time.time() > expires_at:
            violations.append(
                GDPRViolation(
    ...
    def validate_lawful_basis(self, lawful_basis: str | None) -> GDPREnforcementResult:
    ...
    def validate_retention_policy(
        ...
        stored_since_epoch: float | None = None,
    ...
    def validate_subject_rights_handlers(
        self,
        registered_handlers: list[str] | None,
    ) -> GDPREnforcementResult:
    ...
    def enforce_all(
        ...
        registered_handlers: list[str] | None = None,
    ) -> GDPREnforcementResult:
