"""Tool execution and configuration management - Zugang & Berechtigungen domain module."""
...
class ToolRunner:
    """Tool execution and configuration management for the access and permissions domain."""

    def __init__(self, shard: str = "03_zugang_berechtigungen"):
        self.shard = shard
