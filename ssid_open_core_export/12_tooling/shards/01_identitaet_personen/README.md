# Tooling - Identitaet & Personen

## Purpose

This shard provides Developer tooling, CLI runners, configuration validation, and evidence emission utilities within the domain of personal identity.
