"""Tool execution and configuration management - Familie & Soziales domain module."""
...
class ToolRunner:
    """Tool execution and configuration management for the family and social domain."""

    def __init__(self, shard: str = "07_familie_soziales"):
        self.shard = shard
