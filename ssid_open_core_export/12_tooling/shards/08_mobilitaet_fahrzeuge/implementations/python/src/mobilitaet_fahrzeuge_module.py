"""Tool execution and configuration management - Mobilitaet & Fahrzeuge domain module."""
...
class ToolRunner:
    """Tool execution and configuration management for the mobility and vehicles domain."""

    def __init__(self, shard: str = "08_mobilitaet_fahrzeuge"):
        self.shard = shard
