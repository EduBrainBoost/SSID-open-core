# Tooling - Mobilitaet & Fahrzeuge

## Purpose

This shard provides Developer tooling, CLI runners, configuration validation, and evidence emission utilities within the domain of mobility and vehicles.
