# Tooling - Bildung & Qualifikationen

## Purpose

This shard provides Developer tooling, CLI runners, configuration validation, and evidence emission utilities within the domain of education and qualifications.
