"""Tool execution and configuration management - Handel & Transaktionen domain module."""
...
class ToolRunner:
    """Tool execution and configuration management for the trade and transactions domain."""

    def __init__(self, shard: str = "15_handel_transaktionen"):
        self.shard = shard
